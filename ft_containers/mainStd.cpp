...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/09/01 18:44:21 by hyungyyo          #+#    #+#             */
/*   Updated: 2021/10/06 14:54:05 by hyungyyo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void test_vector()
{
    std::vector<int> intv1;
    std::vector<int> intv2((size_t)10, 42);
    ...
    for (std::vector<int>::iterator iter = intv2.begin(); iter != intv2.end(); iter++)
    {
        std::cout << *iter << " ";
    }
    std::cout << std::endl;
    std::cout << "intv1 reverse iterator = ";
    for (std::vector<int>::reverse_iterator riter = intv1.rbegin(); riter != intv1.rend(); riter++)
    {
        std::cout << *riter << " ";
    }
    std::cout << std::endl;
...
void test_map()
{
    ...
    m1.insert(std::pair<int, std::string>(42, "forty-two"));
    m1.insert(std::pair<int, std::string>(1, "one"));
    m1.insert(std::pair<int, std::string>(22, "twenty-two"));
    ...
    for (std::map<int, std::string>::reverse_iterator iter = m1.rbegin(); iter != m1.rend(); iter++)
    {
        std::cout << "[" << iter->first << ", " << (*iter).second << "]" << std::endl;
    }
    ...
    m2["ecole"] = 42;
    m2["seoul"] = 42;
    for (std::map<std::string, int>::iterator iter = m2.begin(); iter != m2.end(); iter++)
    {
        std::cout << "[" << iter->first << ", " << (*iter).second << "]" << std::endl;
    }
    ...
    for (std::map<int, std::string>::iterator iter = m3.begin(); iter != m3.end(); iter++)
    {
        std::cout << "[" << iter->first << ", " << (*iter).second << "]" << std::endl;
    }
    ...
    std::cout << "m3.insert(std::pair<int, std::string>(42, \"!!!!!\"))" << std::endl;
    m3.insert(std::pair<int, std::string>(42, "!!!!!"));
    std::cout << "m3 = " << std::endl;
    for (std::map<int, std::string>::iterator iter = m3.begin(); iter != m3.end(); iter++)
    {
        std::cout << "[" << iter->first << ", " << (*iter).second << "]" << std::endl;
    ...
    for (std::map<int, std::string>::iterator iter = m4.begin(); iter != m4.end(); iter++)
    {
        std::cout << "[" << iter->first << ", " << (*iter).second << "]" << std::endl;
    }
    ...
    std::map<int, std::string>::key_compare m4_keycomp = m4.key_comp();
    if (m4_keycomp(2, 4))
    ...
    std::map<int, std::string>::value_compare m4_valuecomp = m4.value_comp();
